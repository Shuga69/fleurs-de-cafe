...
wishList.length?document.getElementById('wish-counter mobile').style.display = 'flex':document.getElementById('wish-counter').style.display = 'none'
document.getElementById('wish-counter mobile').innerText = wishList.length

cartList.length?document.getElementById('cart-counter mobile').style.display = 'flex':document.getElementById('cart-counter').style.display = 'none'
document.getElementById('cart-counter mobile').innerText = cartList.length